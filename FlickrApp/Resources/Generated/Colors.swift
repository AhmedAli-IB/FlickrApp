...
internal struct ColorName {
  ...
  /// <span style="display:block;width:3em;height:2em;border:1px solid black;background:#eeeeff"></span>
  /// Alpha: 100% <br/> (0xeeeeffff)
  internal static let paperColor = ColorName(rgbaValue: 0xeeeeffff)
